const LoadingFixed = ({ children = '' }) => {
	return (
		...
		>
			...
			{/* Konten loading */}
			<div className="min-w-sm relative flex flex-col items-center justify-center p-6 rounded-xl shadow-lg bg-base-200/50 backdrop-saturate-150 backdrop-contrast-125">
				...
				{/* Pesan teks */}
				<div className="w-full text-center mt-4 px-8 py-4 rounded-md text-sm font-medium text-base-content bg-base-100 shadow shadow-base-content/50 border border-base-content/50">
